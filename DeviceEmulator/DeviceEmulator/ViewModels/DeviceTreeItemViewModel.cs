...
namespace DeviceEmulator.ViewModels
{
    ...
    public class DeviceTreeItemViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Status indicator color (green = running, gray = stopped).
        /// </summary>
        public Brush StatusColor => _isRunning 
        ...
        /// <summary>
        /// Whether this item is selected in the TreeView.
        /// </summary>
    ...
    /// <summary>
    /// Category node in TreeView (Serial Devices, TCP Devices).
    /// </summary>
    public class DeviceCategoryViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<DeviceTreeItemViewModel> Devices { get; } = new ObservableCollection<DeviceTreeItemViewModel>();
